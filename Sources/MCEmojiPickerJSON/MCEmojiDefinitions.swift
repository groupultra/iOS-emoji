...
enum MCEmojiDefinitions {
    ...
    static let peopleEmojis: MCEmojiCategory = .init(
        type: .people,
        emojis: [
            MCEmoji(
                emojiKeys: [0x1F600],
    ...
    static let natureEmojis: MCEmojiCategory = .init(
        type: .nature,
        emojis: [
            MCEmoji(
                emojiKeys: [0x1F435],
    ...
    static let foodAndDrinkEmojis: MCEmojiCategory = .init(
        type: .foodAndDrink,
        emojis: [
            MCEmoji(
                emojiKeys: [0x1F347],
    ...
    static let activityEmojis: MCEmojiCategory = .init(
        type: .activity,
        emojis: [
            MCEmoji(
                emojiKeys: [0x1F383],
    ...
    static let travelAndPlacesEmojis: MCEmojiCategory = .init(
    ...
    static let objectEmojis: MCEmojiCategory = .init(
        type: .objects,
        emojis: [
            MCEmoji(
                emojiKeys: [0x1F453],
    ...
    static let symbolEmojis: MCEmojiCategory = .init(
        type: .symbols,
        emojis: [
            MCEmoji(
                emojiKeys: [0x1F3E7],
    ...
    static let flagEmojis: MCEmojiCategory = .init(
        type: .flags,
        emojis: [
            MCEmoji(
                emojiKeys: [0x1F3C1],
